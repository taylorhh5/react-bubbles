...
A token is used to provide proof of authentication.

- [ ] What steps can you take in your web apps to keep your data secure?

Steps to keep your data secure is with the use of tokens and private routes.


- [ ] Describe how web servers work.

Web servers are computers that stores code for websites. It "serves" web pages to users upon request.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.


The U in crud stands for update and we learned about put requests that update information.
